class Commands:
    ...
    JOIN_LOBBY                  = 'join_game_lobby'              # Joins an existing lobby
    ...
    # Game Commands
    PRESET_DONE                 = 'game_preset_done'             # Sends a signal to the gameserver that the player is done with the preset phase
    ...
    GAME_TURN_FINISHED          = 'game_turn_finished'           # Sends a signal to the gameserver that the player is done with his turn
